...
const UrdfUploader = () => {
    ...
    const handlePlayRecordedData = useCallback((jointStatesData) => {
        ...
        console.log('Playing recorded joint states data:', jointStatesData.length, 'frames');
    ...
    useEffect(() => {
        if (mediaPipeTrackerRef.current && mediaPipeTrackerRef.current.getVideoElement) {
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className={`w-2 h-2 rounded-full ${
                                            controlSource === 'camera' ? 'bg-blue-500' : 
                                            controlSource === 'recorded' ? 'bg-purple-500' : 'bg-gray-500'
                                        }`}></div>
                                    ...
                                    {recordingStatus && (
                                        <div className="text-cyan-400 text-xs mt-1">{recordingStatus}</div>
                                    )}
                                </div>
                            </div>
                        )}
